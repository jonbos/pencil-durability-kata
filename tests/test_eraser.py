...
class EraseTests(unittest.TestCase):
    ...
    # tests _erase_char private method
    ...
    def test_should_remove_char_and_write_erase_char_in_its_place(self):
        self.paper.text = 'ABC'

        self.eraser.erase('A', paper=self.paper)

        self.assertEqual(self.paper.text, (Eraser.ERASE_CHAR + 'BC'))
